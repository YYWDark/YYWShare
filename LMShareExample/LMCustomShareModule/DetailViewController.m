...
/**
 组装参数
 @param contentType 分享内容的type
 @return 字典类型
 */
- (NSMutableDictionary *)packageDictionaryFromContentType:(LMSSDKContentType )contentType {
    ...
    [parameters LMSSDKSetupShareParamsByText:shareText
                                    images:fileDatas
                                       url:url
                                     title:@"i am a title"
                                      type:contentType];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    LMSSDKContentType type = [self.contentTypes[indexPath.row] integerValue];
    [LMShareSDK share:self.platformType
           parameters:[self packageDictionaryFromContentType:type]
       onStateChanged:^(LMSSDKResponseState state, NSDictionary *userData, NSError *error) {
