...
// 返回一个
//
// @param imageDatas <#imageDatas description#>
// @param thumbnailImage <#thumbnailImage description#>
// @return <#return value description#>
// */
//- (UIImage *)findThumbnailDataFromImageDatas:(NSArray *)imageDatas thumbnails:(UIImage *)thumbnailImage;
@end
